  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-52 bg-surface-card border-r border-surface-border flex flex-col">
      <div className="px-5 py-5 border-b border-surface-border">
        <p className="text-xs text-slate-500 font-mono">GPU MONITOR</p>
        <p className="text-slate-200 font-semibold text-sm mt-0.5">183.111.14.6</p>
      </div>
